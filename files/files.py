...
# writer.writerow() - запись одной строки в CSV файл
...
with open('test.csv', 'w') as csvfile:
    ...
    writer.writerow(['Nikita', '10', 'Bishkek'])



# writer.writerows() - Запись нескольких строк сразу
data = [
    ['Марка', 'год издания', 'цена'],
    ['Ford mustang', 2017, 21000],
    ['Mercedes 220', 2007, 1000],
    ['BMW m8', 2024, 150000]
]
with open('writerows.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerows(data)


with open('writerows.csv', 'r') as file:
    reader = csv.reader(file)
    for row in reader:
        print(row)


# csv.DictWriter() - создание объекта для записи данных в виде словаря
